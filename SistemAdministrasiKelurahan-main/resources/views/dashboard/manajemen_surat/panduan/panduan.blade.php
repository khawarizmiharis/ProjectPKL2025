    ...
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            ...
            <div class="m-5">
                ...
                <p>
                    Salah satu fungsi aplikasi Sistem Informasi Kelurahan (SID) adalah untuk mengoptimalkan pelayanan administrasi publik berbasis data. Pelayanan administrasi publik yang bisa dilakukan dengan aplikasi SID meliputi pelayanan olah data dan pelayanan olah dokumen/surat. Pelayanan olah data dapat dilakukan dengan memanfaatkan fungsi-fungsi statistik yang dapat dimanfaatkan untuk laporan dan rujukan pengambilan keputusan. Pelayanan olah dokumen bisa dilakukan dari data yang telah diolah dan/atau dari pengelolaan administrasi surat-menyurat.
                </p>
                <p>


                    Aplikasi SID menghimpun seluruh data penduduk kelurahan, sehingga bisa digunakan untuk data dasar pembuatan surat administrasi kependudukan. Pelayanan administrasi persuratan itu dapat dikelola oleh pemerintah kelurahan di kantor pemerintah kelurahan masing-masing. Tata cara pemanfaatan module cetak surat aplikasi SID dalam alur pelayanan publik di kantor kelurahan secara garis besar dapat dilakukan dengan urutan sebagai berikut:
                </p>
                <p>
                    Penduduk pemohon surat datang dengan membawa kartu identitas diri (KTP atau Kartu Keluarga/KK) dan diterima oleh staf pemerintah kelurahan yang bertugas dalam pelayanan.
                    ...
                    Pilih nama dan jabatan kepala kelurahan atau perangkat kelurahan yang berwenang melakukan pengesahan atas nama kepala kelurahan.
                    ...
                    Surat dapat dicetak dua eksemplar, 1 eks. untuk penduduk pemohon surat dan 1 eks. untuk arsip pemerintah kelurahan.
